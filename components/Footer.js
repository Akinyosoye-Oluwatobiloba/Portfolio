...
const Footer = () => {
  return (
    <div className='relative  sm:top-80 mt-80 sm:pt-80'>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="mt-8 overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                            ...
                            <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                                ...
                                <div class="ml-4 text-md tracking-wide font-semibold w-40">
                                    Anchor University, Ayobo road Street, Lagos State,
                                    <p>Postal Code: 100001</p>
                                </div>
                            </div>
                        ...
                        <form action='https://getform.io/f/cdec060a-8653-4344-83f2-f107f784de43' class="p-6 flex flex-col justify-center">
                ...
                {/* <HiOutlineChevronDoubleUp className='items-center text-[#5651e5]  ' size={30}/> */}
    </div>
                </div>
            </div>
        </div>
